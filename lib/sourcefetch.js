      ...
      'atom-text-editor': [
        {
          ...
          shouldDisplay: function shouldDisplay(event) {
            ...
            if (editor = atom.workspace.getActiveTextEditor()) {
              ...
              // Find screen position and set cursor to where you right clicked
              screenPosition = editor.screenPositionForPixelPosition({top: event.layerY, left: event.layerX });
              ...
              if(cursor.isInsideWord()){
                ...
                // find Reference
                self.referenceUrl = false;
                self.referenceUrl = self.findRefence(word);
